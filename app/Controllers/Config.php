...
class Config extends Secure_Controller
{
    ...
    public function postSaveGeneral(): void
    {
        ...
        if ((int) $batch_save_data['category_dropdown'] === 1) {
        ...
        } elseif ((int) $batch_save_data['category_dropdown'] === NO_DEFINITION_ID) {
    ...
    /**
     * Saves tax configuration and the pounds-per-dollar display rate.
     *
     * @throws ReflectionException
     * @noinspection PhpUnused
     */
    public function postSaveTax(): void
    {
        ...
        $lbp_exchange_rate  = $this->request->getPost('lbp_exchange_rate');

        if (! is_numeric($lbp_exchange_rate) || (float) $lbp_exchange_rate <= 0) {
            echo json_encode(['success' => false, 'message' => lang('Config.exchange_rate_number')]);
        ...
        $batch_save_data = [
            ...
            'lbp_exchange_rate'         => (string) $lbp_exchange_rate,
        ];
