...
class Customers extends Persons
{
    ...
    /**
     * Initializes customer dependencies and decrypts the Mailchimp list ID when encryption is configured.
     */
    public function __construct()
    {
        ...
        if (! empty(config('Encryption')->key) && ! empty($this->config['mailchimp_list_id'])) {
