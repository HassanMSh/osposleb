...
class Employees extends Persons
{
    ...
    /**
     * Inserts or updates an employee and returns a JSON success or failure result.
     * Menu placement is assigned by the employee model policy, not by posted form data.
     */
    public function postSave(int $employee_id = NEW_ENTRY): void
    {
        ...
        if ($this->employee->save_employee($person_data, $employee_data, $grants_array, $employee_id)) {
            ...
            $message = $this->employee->get_save_failure_reason() === 'last_administrator'
                ? lang('Employees.cannot_remove_last_administrator')
                : lang('Employees.error_adding_updating') . ' ' . $first_name . ' ' . $last_name;
