...
/**
 * Builds an item import CSV template with stock, tax, location, and attribute columns.
 *
 * @param list<string> $stock_locations
...
function generate_import_items_csv(array $stock_locations, array $attributes): string
{
    ...
    $csv_headers .= 'Id,Barcode,"Item Name",Category,"Supplier ID","Cost Price","Unit Price","Tax 1 Name","Tax 1 Percent","Tax 2 Name","Tax 2 Percent","Reorder Level",Description,"Allow Alt Description","Item has Serial Number",Image,HSN,"Stock Type","Tax Mode","Tax Exemption Reason"';
