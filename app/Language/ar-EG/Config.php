...
return [
    ...
    'till_category_order_help'                  => 'اكتب قسماً واحداً في كل سطر. يظهر السطر الأول أولاً. تُضاف الأقسام الجديدة تلقائياً في أسفل القائمة. تظهر الأقسام غير المدرجة بعدها بترتيب أبجدي.',
