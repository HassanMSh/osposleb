...
return [
    ...
    'till_category_order'                       => 'ترتيب الأقسام',
    'till_category_order_help'                  => 'اكتب قسماً واحداً في كل سطر. يظهر السطر الأول أولاً. تُضاف الأقسام الجديدة تلقائياً في أسفل القائمة. تظهر الأقسام غير المدرجة بعد الأقسام المدرجة بترتيب أبجدي، لكن قبل قسم الإضافات إذا كان في السطر الأخير. يظهر قسم الإضافات في الآخر إلا إذا نقلته.',
    'till_category_order_too_long'              => 'قائمة ترتيب الأقسام طويلة جداً. اختصرها إلى 500 حرف أو أقل.',
    ...
    'lbp_exchange_rate'                         => 'الليرة اللبنانية لكل دولار أميركي',
    'lbp_exchange_rate_help'                    => 'يُستخدم فقط للمجاميع المعروضة بالليرة. ولا يغيّر المبالغ المخزّنة بالدولار.',
    'exchange_rate_number'                      => 'يجب أن يكون سعر الصرف رقماً موجباً.',
