...
return [
    ...
    'cost_price_non_negative'                 => 'Wholesale price cannot be negative.',
    ...
    'csv_import_barcode_duplicate'            => 'Barcode {1} on line {0} is already used by item: {2}.',
    ...
    'csv_import_stock_type_invalid'           => 'Stock Type must be Stock or Non-stock.',
    'csv_import_tax_mode_invalid'             => 'Tax Mode must be Default, Own, or No TVA.',
    'csv_import_own_tax_required'             => 'Tax Mode Own needs at least one Tax 1 or Tax 2 name with a numeric percent.',
    'csv_import_tax_columns_must_be_empty'    => 'Tax 1 and Tax 2 must be empty when Tax Mode is Default or No TVA.',
    'csv_import_tax_exemption_reason_invalid' => 'Tax Exemption Reason is only used with No TVA and must be exempt or zero-rated.',
    'csv_import_no_tva_destination_based_tax' => 'No TVA cannot be imported while destination-based tax is enabled.',
    ...
    'markup'                                  => '',
    'name'                                    => 'Item Name',
    'name_length_limit'                       => 'Maximum item name length: 255 characters.',
    'name_max_length'                         => 'Item name cannot be longer than 255 characters.',
    ...
    'unit_price_non_negative'                 => 'Retail price cannot be negative.',
    ...
    'tax_mode_inherited'                      => 'Inherited global rate {0}',
    'tax_mode_own'                            => 'Use own rate',
    'tax_mode_none'                           => 'No TVA',
    'tax_exemption_reason'                    => 'No-TVA reason',
    'tax_reason_exempt'                       => 'Exempt',
    'tax_reason_zero_rated'                   => 'Zero-rated',
    'tax_mode_invalid'                        => 'Invalid TVA treatment.',
];
