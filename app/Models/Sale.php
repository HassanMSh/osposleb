...
class Sale extends Model
{
    ...
    /**
     * Updates a sale and its payment rows after allowing only cash payments.
     *
     * @param int|string|null           $sale_id   Sale identifier to update.
     * @param array<string, mixed>|null $sale_data Sale and payment data.
     */
    public function update($sale_id = null, $sale_data = null): bool
    {
        if (! $this->hasOnlyCashPayments($sale_data['payments'] ?? null)) {
            return false;
        }
    ...
    /**
     * Checks that sale payment data contains only cash or an internal cash adjustment.
     *
     * @param array<int|string, array<string, mixed>>|null $payments Payment rows to validate.
     */
