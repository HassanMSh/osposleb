...
<?= form_open('config/saveTax/', ['id' => 'tax_config_form', 'class' => 'form-horizontal']) ?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-xs-2">
                    <?= form_checkbox([
                        ...
                        'id'      => 'tax_included',
                        'value'   => 'tax_included',
                        'checked' => (int) $config['tax_included'] === 1,
                    ]) ?>
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                <?= form_label(lang('Config.lbp_exchange_rate'), 'lbp_exchange_rate', ['class' => 'control-label col-xs-2']) ?>
                <div class="col-xs-2">
                    <?= form_input([
                        'name'  => 'lbp_exchange_rate',
                        'id'    => 'lbp_exchange_rate',
                        'class' => 'form-control input-sm',
                        'value' => esc($config['lbp_exchange_rate'] ?? '89500'),
                    ]) ?>
                    <span class="help-block"><?= esc(lang('Config.lbp_exchange_rate_help')) ?></span>
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-xs-2">
                    <?= form_checkbox([
                        ...
                        'checked' => (int) $config['use_destination_based_tax'] === 1,
                    ]) ?>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#tax_config_form').validate($.extend(form_support.handler, {
            ...
            messages: {
                ...
                lbp_exchange_rate: {
                    number: "<?= lang('Config.exchange_rate_number') ?>"
                },
            }
        }));
    });
