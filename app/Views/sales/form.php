    ...
    ?>
            <div class="form-group form-group-sm">
                ...
                <div class="col-xs-4">
                    ...
                    <?= form_dropdown("payment_type_{$i}", $payment_options, $row->cash_adjustment ? lang('Sales.cash') : $row->payment_type, ['id' => "payment_types_{$i}", 'class' => 'form-control']) ?>
                </div>
                <div class="col-xs-4">
                    <div class="input-group input-group-sm">
                        <?php if (! is_right_side_currency_symbol()): ?>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-xs-4">
                    <?= form_dropdown("refund_type_{$i}", $refund_options, lang('Sales.cash'), ['id' => "refund_types_{$i}", 'class' => 'form-control']) ?>
                </div>
                <div class="col-xs-4">
                    <div class="input-group input-group-sm">
                        <?php if (! is_right_side_currency_symbol()): ?>
