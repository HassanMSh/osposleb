...
?>
        ...
        <?php if ($config['receipt_show_total_discount'] && $discount > 0) { ?>
            <tr>
                <td colspan="3" class="receipt-label receipt-border-top"><?= lang('Sales.sub_total') ?></td>
                <td class="total-value receipt-border-top"><span dir="ltr"><?= to_currency($prediscount_subtotal) ?></span></td>
            </tr>
            <tr>
                <td colspan="3" class="receipt-label"><?= lang('Sales.customer_discount') ?>:</td>
...
?>
        ...
        <tr>
            <td colspan="3" class="receipt-label<?= $border ? ' receipt-border-top' : '' ?>"><?= lang('Sales.total_to_pay') ?></td>
...
foreach ($payments as $payment) {
    ...
    if ($show_payment_rows) {
        ?>
            <tr>
                <td colspan="3" class="receipt-label"><?= $splitpayment[0] ?> </td>
...
?>
        ...
        <?php if (isset($cur_giftcard_value) && $show_giftcard_remainder) { ?>
            <tr>
                <td colspan="3" class="receipt-label"><?= lang('Sales.giftcard_balance') ?></td>
                <td class="total-value"><span dir="ltr"><?= to_currency($cur_giftcard_value) ?></span></td>
            </tr>
        <?php } ?>
        <?php if ($amount_change > 0) { ?>
            <tr>
                <td colspan="3" class="receipt-label"><?= esc(lang($only_sale_check ? 'Sales.check_balance' : 'Sales.change_due')) ?></td>
                <td class="total-value"><span dir="ltr"><?= to_currency($amount_change) ?></span></td>
            </tr>
        <?php } elseif ($amount_change < 0) { ?>
            <tr>
                <td colspan="3" class="receipt-label"><?= lang('Sales.amount_due') ?></td>
                <td class="total-value"><span dir="ltr"><?= to_currency($amount_change) ?></span></td>
            </tr>
        <?php } ?>
        <tr>
            <td colspan="4" class="receipt-label"><?= esc(lang('Sales.lbp_rate')) ?> <span dir="ltr"><?= esc(format_lbp($lbp_rate ?? $config['lbp_exchange_rate'])) ?></span></td>
        </tr>
    </table>
