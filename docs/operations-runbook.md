...
The database stores prices in dollars with two decimal places, and the current Settings rate controls the LBP values shown on item forms, the Items list, the till, and receipts.
