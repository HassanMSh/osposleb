...
final class ReceiptLayoutTest extends CIUnitTestCase
{
    ...
    public function testReceiptPrintRulesAreScopedToSalesReceipt(): void
    {
        ...
        $this->assertStringContainsString('@page', $receiptPage);
        $this->assertStringContainsString('#receipt_wrapper', $receiptPage);
    }
    ...
    public function testReceiptPrintsChangeDueForOverpayment(): void
    {
        ...
        $this->assertStringContainsString(lang('Sales.change_due'), $output);
    }
    ...
    public function testReceiptPrintsAmountDueForUnderpayment(): void
    {
        ...
        $this->assertStringContainsString(lang('Sales.amount_due'), $output);
    }
    ...
    public function testReceiptPrintsRowsForMultiplePayments(): void
    {
        ...
        $this->assertStringContainsString(lang('Sales.cash'), $output);
        $this->assertStringContainsString(lang('Sales.giftcard'), $output);
    }
